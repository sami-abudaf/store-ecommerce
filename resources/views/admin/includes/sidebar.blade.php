...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main"  id="main-menu-navigation" data-menu="menu-navigation" >
            ...
            <li class=" nav-item"><a href=""><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">لغات الموقع </span><span class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
                <ul class="menu-content">
                    ...
                    <li class=" nav-item">
                        <a href="#">
                            ...
                            <span class="menu-title" data-i18n="nav.templates.main">{{__('admin/sidebar.sections')}} </span>
                            <span class="badge badge badge-danger badge-pill float-right mr-2">{{\App\Models\Category::count()}} </span>
                        </a>
                <ul class="menu-content">
                    <li>
                        <a class="menu-item" href="{{route('admin.maincategories')}}" data-i18n="nav.templates.vert.main">عرض الكل </a>

                    </li>
                    <li><a class="menu-item" href="{{route('admin.maincategories.create')}}" data-i18n="nav.templates.horz.main">اضاقة قسم</a>
        ...
        <!--  <li class="nav-item"><a href=""><i class="la la-group"></i>
            ...
            @can('brands')
            <li class=" nav-item"><a href="#"><i class="la la-columns"></i><span class="menu-title" data-i18n="nav.page_layouts.main">{{__('admin/sidebar.Commercial brands')}}</span><span class="badge badge badge-pill badge-danger float-right mr-2">{{\App\Models\Brand::count()}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.brands')}}" data-i18n="nav.page_layouts.1_column">عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.brands.create')}}" data-i18n="nav.page_layouts.2_columns">اضافة ماركة جديدة</a>
                    </li>

                </ul>
            </li>
            @endcan
            <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">{{__('admin/sidebar.Tags')}}</span>
                    <span
                        class="badge badge badge-success badge-pill float-right mr-2">{{\App\Models\Tag::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.tags')}}" data-i18n="nav.navbars.nav_light">عرض الكل</a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.tags.create')}}" data-i18n="nav.navbars.nav_dark">اضافة علامة جديدة</a>
                    </li>


                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="la la-arrows-v"></i><span class="menu-title" data-i18n="nav.vertical_nav.main">{{__('admin/sidebar.Products')}}</span>
                    <span
                        class="badge badge badge-warning badge-pill float-right mr-2">{{\App\Models\Product::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.products')}}" data-i18n="nav.vertical_nav.vertical_nav_fixed">عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.products.general.create')}}" data-i18n="nav.vertical_nav.vertical_nav_static">اضافة منتج جديد</a>
                    </li>

                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="la la-header"></i><span class="menu-title" data-i18n="nav.page_headers.main">{{__('admin/sidebar.Product Properties')}}</span>
                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">{{\App\Models\Attribute::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.attributes')}}" data-i18n="nav.page_headers.headers_breadcrumbs_basic">عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.attributes.create')}}" data-i18n="nav.page_headers.headers_breadcrumbs_top">اضافة جديدة</a>
                    </li>

                </ul>
            </li>
            <li class=" nav-item"><a href="#"><i class="la la-download"></i><span class="menu-title" data-i18n="nav.footers.main"> {{__('admin/sidebar.Properties values')}}</span>
                    <span
                        class="badge badge badge-success badge-pill float-right mr-2">{{\App\Models\Option::count()}}</span>

                </a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.options')}}" data-i18n="nav.footers.footer_light">عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.options.create')}}" data-i18n="nav.footers.footer_dark">اضافة جديدة</a>
                    </li>

                </ul>
            </li>
            @can('sliders')
            <li class=" nav-item"><a href="#"><i class="la la-image"></i><span class="menu-title" data-i18n="nav.color_palette.main">{{__('admin/sidebar.main slider')}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.sliders.create')}}" data-i18n="nav.color_palette.color_palette_primary">اضافة صور السلايدر</a>
                    </li>
            ...
            @endcan
            @can('settings')
            <li class=" nav-item"><a href="#"><i class="la la-wrench"></i><span class="menu-title" data-i18n="nav.starter_kit.main">{{__('admin/sidebar.settings')}}</span></a>
                <ul class="menu-content">
            ...
            @endcan
            @can('roles')
            <li class=" nav-item"><a href="#"><i class="la la-android"></i><span class="menu-title" data-i18n="nav.menu_levels.main">{{__('admin/sidebar.Permissions management')}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.roles.index')}}" data-i18n="nav.menu_levels.second_level">عرض الكل</a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.roles.create')}}" data-i18n="nav.dash.crypto">إضافة
                            جديدة </a>
                    </li>
                </ul>
            </li>
            @endcan
            @can('users')
            <li class=" nav-item"><a href="#"><i class="la la-users"></i><span class="menu-title" data-i18n="nav.project.main">{{__('admin/sidebar.Control Panel users')}} </span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.users.index')}}" data-i18n="nav.project.project_summary">عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.users.create')}}" data-i18n="nav.project.project_tasks">اضافة جديدة</a>
                    </li>
                </ul>
            </li>
            @endcan
