                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row" >
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <p for="projectinput1">اختر القسم
                                                            </p>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <p for="projectinput1"> اختر ألعلامات الدلالية
                                                            </p>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <p for="projectinput1"> اختر ألماركة
                                                            </p>
                                                            <select name="brand_id" class="select2 form-control" multiple>
