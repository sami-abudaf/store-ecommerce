        ...
        <div class="no-index">
                                    ...
                                    <section class="page-content" id="content">
                                        ...
                                        <div class="images-container list_thumb">
                                            ...
                                            <div class="product-cover">
                                                ...
                                                <a href="#" class="layer hidden-sm-down product-images" data-toggle="modal" data-target="#product-modal"
                                ...
                                <div class="col-lg-7 col-md-8 col-xs-12 mt-sm-20">
                                    <div class="product-information">
                                                ...
                                                <div class="productdetail-right col-12 col-lg-6 col-md-6">
                                                        ...
                                                        <div class="product-prices">
                                                            ...
                                                            <div class="product-price " itemprop="offers" itemscope="" itemtype="https://schema.org/Offer">
                                                                ...
                                                                <div class="current-price">
                                                                    ...
                                                                    <span itemprop="price" class="price" content="30">{{$product->price}}</span>
                                                                </div>
                                                    ...
                                                    <div id="_desktop_productcart_detail">
                                                        <div class="product-add-to-cart in_border">
                                                            <div class="add">
                                                                <a class="btn btn-primary add-to-cart cart-addition"
                                                                   data-product-id="{{$product -> id}}"
                                      ...
                                      <span class="input-group-addon bootstrap-touchspin-prefix" style="display: none;">
                                                                ...
                                                                <input type="text" name="qty" id="quantity_wanted" value="{{$product->qty}}" class="input-group form-control" min="1" style="display: block;">
                                                                <span class="input-group-addon bootstrap-touchspin-postfix" style="display: none;"></span>
                                                                <span class="input-group-btn-vertical"><button class="btn btn-touchspin js-touchspin bootstrap-touchspin-up" type="button"><i class="material-icons touchspin-up"></i></button><button class="btn btn-touchspin js-touchspin bootstrap-touchspin-down" type="button"><i class="material-icons touchspin-down"></i></button></span></div>
                                                        </div>
                                                    </div>
            ...
            <span class="seller_name">
                Taylor Jonson
                                            ...
                                            <div class="block_content">
                                                <div id="productlist18196113" class="product_list grid owl-carousel owl-theme multi-row owl-rtl owl-loaded owl-drag" data-autoplay="false" data-autoplaytimeout="6000" data-loop="false" data-margin="0" data-dots="false" data-nav="true" data-items="1" data-items_large="1" data-items_tablet="1" data-items_mobile="1">
                                                    ...
                                                    <div class="owl-stage-outer">
                                                        <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 540px;"><div class="owl-item active lastActiveItem" style="width: 270px;"><div class="item  text-center">
                    ...
                    @include('front.related-products')
...
<script>
    ...
    $(document).on('click' ,'.product-images',function (){
        $('.model-product-images-'+$(this).attr('data-product-id')).css("display","block");
