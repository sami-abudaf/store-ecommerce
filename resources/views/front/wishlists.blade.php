                                            ...
                                            @foreach($products as $product)
                                                ...
                                                <div class="thumbnail-container">
                                                    ...
                                                    <a href="" class="thumbnail product-thumbnail two-image">
                                                        <img class="img-fluid image-cover" src="{{$product ->images[0]->photo ?? ''}}" alt="" data-full-size-image-url="http://demo.bestprestashoptheme.com/savemart/29-large_default/brown-bear-printed-sweater.jpg" width="600" height="600" style="padding: 40px;">
                                                        <img class="img-fluid image-secondary" src="{{$product ->images[0]->photo ?? ''}}" alt="" data-full-size-image-url="http://demo.bestprestashoptheme.com/savemart/30-large_default/brown-bear-printed-sweater.jpg" width="600" height="600">
                                                    </a>
                                                ...
                                                <div class="product-description">
                                                    <div class="product-groups">
                                                        ...
                                                        <div class="category-title"><a href="">Smartphone &amp; Tablet</a></div>
                                                    ...
                                                    <div class="product-buttons d-flex justify-content-center" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                                        ...
                                                        <a class="removeFormWishlist addToWishlist wishlistProd_2" href="#"
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click' ,'.removeFormWishlist',function(e){
            e.preventDefault();
