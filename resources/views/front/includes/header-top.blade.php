                        ...
                        <div class="language-list dropdown-menu">
                            <div class="language-list-content text-left">
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/en/module/novblockwishlist/mywishlist">
                                            <img class="img-fluid" src="http://demo.bestprestashoptheme.com/savemart/img/l/1.jpg" alt="English" width="16" height="11">
                                            <span>English</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/fr/module/novblockwishlist/mywishlist">
                                            <img class="img-fluid" src="http://demo.bestprestashoptheme.com/savemart/img/l/2.jpg" alt="Français" width="16" height="11">
                                            <span>Français</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/es/module/novblockwishlist/mywishlist">
                                            <img class="img-fluid" src="http://demo.bestprestashoptheme.com/savemart/img/l/3.jpg" alt="Español" width="16" height="11">
                                            <span>Español</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/it/module/novblockwishlist/mywishlist">
                                            <img class="img-fluid" src="http://demo.bestprestashoptheme.com/savemart/img/l/4.jpg" alt="Italiano" width="16" height="11">
                                            <span>Italiano</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/pl/module/novblockwishlist/mywishlist">
                                            <img class="img-fluid" src="http://demo.bestprestashoptheme.com/savemart/img/l/5.jpg" alt="Polski" width="16" height="11">
                                            <span>Polski</span>
                                        </a>
                                    </div>
                                </div>
                                <div class="language-item current flex-first">
                                    <div class="current">
                                        <a href="http://demo.bestprestashoptheme.com/savemart/ar/module/novblockwishlist/mywishlist">
                                            <img class="img-fluid" src="http://demo.bestprestashoptheme.com/savemart/img/l/6.jpg" alt="اللغة العربية" width="16" height="11">
