...
<div id="quickview-modal-3-95" class="modal fade quickview in  quickview-model-product-details-{{$product->id}}" tabindex="-1" role="dialog" style="display: hidden; background-color: rgb(0 0 0 / 80%);">
            ...
            <div class="modal-body">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-7 col-sm-7">
                        <h1 class="product-name">Categories:</h1>
