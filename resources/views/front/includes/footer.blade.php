<footer class="footer footer-three" style="margin-top: 20px;">
    <div class="inner-footer">
        <div class="container">
            <div class="row">
                <div class="nov-row footer-top " data-nov-full-width="true" style="position: relative; right: -74.5px; box-sizing: border-box; -webkit-box-flex: 0; flex: 0 0 1349px; max-width: 1349px; padding-right: 89.5px; padding-left: 89.5px;"><div class="nov-row-wrap row"><div class="nov-modules col-lg-12 col-md-12 "><div class="block nov-wrap"><div class="title_block">SIGN UP TO NEWSLETTER</div><div class="block_newsletter">
            ...
            <button class="btn btn-secondary effect-btn" name="submitNewsletter" type="submit">
                <span>subscribe</span>
                            ...
                            </div></div></div></div><div class="nov_row-full-width clearfix w-100"></div><div class="nov-row footer-center " data-nov-full-width="true" style="position: relative; right: -74.5px; box-sizing: border-box; -webkit-box-flex: 0; flex: 0 0 1349px; max-width: 1349px; padding-right: 89.5px; padding-left: 89.5px;"><div class="nov-row-wrap row"><div class="nov-html col-xl-4 col-lg-4 col-md-4">
                            <div class="block">
